...
- [ ] Verify Suit Induction through the supported Visual Script player-energy API: friendly/terminal-access authorization, Stable/Recharging-only activation, 2.5% suit charge per second, 20 shield-energy cost per recipient, 3 m fixed clearance, 1000 m maximum, immediate stop on field failure, and no client authority.
