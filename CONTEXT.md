...
- 2026-09-24: The private-beta exact-position Shield Health HUD renderer is a native client session component of the required Visual Framework. It draws player-local telemetry at the top-right from a versioned, read-only snapshot, requires no Pulsar or external loader, and leaves shield authority exclusively in the server runtime. The central notification fallback is retired.
